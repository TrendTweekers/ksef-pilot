    ...
    en: {
      translation: {
        ...
        orders: {
          ...
          empty: "Create a new test order in this dev store, then refresh again. Shopify's read_orders scope only exposes recent orders; older sample orders may show in Shopify admin but not in the API.",
    ...
    pl: {
      translation: {
        ...
        orders: {
          ...
          empty: "Utwórz nowe testowe zamówienie w tym sklepie deweloperskim i odśwież ponownie. Zakres read_orders w Shopify pokazuje tylko świeże zamówienia; starsze przykładowe zamówienia mogą być widoczne w panelu, ale nie w API.",

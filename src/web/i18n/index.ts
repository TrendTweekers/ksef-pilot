    ...
    pl: {
      translation: {
        ...
        settings: {
          ...
          onboardingSellerTitle: "Zapisz dane firmy",
          onboardingSellerBody: "Uzupełnij NIP, nazwę prawną i miejsce wystawienia. Te dane trafią do FA(3).",
          onboardingTokenTitle: "Podłącz token KSeF",
          ...
          tokenConnectedTitle: "Token zapisany i przetestowany",
          tokenConnectedBody: "Ten sklep ma zaszyfrowany token KSeF, który przeszedł test połączenia dla NIP sprzedawcy.",
          tokenNeedsRetestTitle: "Token zapisany, ale wymaga ponownego testu",
          tokenNeedsRetestBody: "Zapisz nowy token lub przetestuj połączenie po zmianie NIP sprzedawcy.",
          tokenMissingTitle: "Brak tokenu KSeF",
          tokenMissingBody: "To jest poprawne podczas pracy testowej. Prawdziwa wysyłka wymaga tokenu.",
          safeTest:
          ...
          accountantEmail: "E-mail księgowości",
          accountantEmailHelp: "Opcjonalnie. Ten adres będzie podpowiadany przy wysyłce XML/PDF z zakładki Faktury.",
          test: "Testuj połączenie",
          save: "Zapisz ustawienia",
          saveAndTest: "Zapisz i testuj token",
        ...
        orders: {
          ...
          buyerJst: "Nabywca JST",
          buyerGv: "Nabywca grupa VAT",
          saveFlag: "Zapisz B2B",
          generate: "Generuj fakturę",
          generateReady: "Generuj gotowe szkice",
          nipSource: "Źródło NIP: {{source}}",
          devCurrency: "Tryb testowy: zamówienie w {{currency}} użyje kursu NBP i pól VAT w PLN w XML FA(3).",
        ...
        invoices: {
          ...
          validatedAt: "FA(3) zwalidowano: {{date}}",
          ...
          email: "Wyślij e-mail",
          emailRecipient: "E-mail odbiorcy",
          emailPlaceholder: "ksiegowosc@example.com",
          emailSent: "Wysłano pakiet faktury {{orderName}} do {{email}}.",
          emailError: "Nie udało się wysłać e-maila z fakturą.",
          ...
          submitted: "Wysłano",
          submitStarted: "{{orderName}} wysłano do obsługi KSeF.",
          submitError: "Nie udało się wysłać faktury do KSeF.",
          refreshStatus: "Odśwież status KSeF",
          statusRefreshed: "Status KSeF odświeżony dla {{orderName}}.",
        ...
        queue: {
          ...
          workerRuntime: "Worker: co {{interval}}s, limit {{limit}}, ostatnie zakończenie: {{last}}.",
          workerNever: "jeszcze nigdy",
    ...
    en: {
      translation: {
        ...
        settings: {
          ...
          onboardingSellerTitle: "Save company details",
          onboardingSellerBody: "Enter the seller NIP, legal name, and place of issue. These fields go into FA(3).",
          onboardingTokenTitle: "Connect the KSeF token",
          ...
          tokenConnectedTitle: "Token saved and tested",
          tokenConnectedBody: "This shop has an encrypted KSeF token that passed the connection test for the seller NIP.",
          tokenNeedsRetestTitle: "Token saved, retest needed",
          tokenNeedsRetestBody: "Save a new token or retest after changing the seller NIP.",
          tokenMissingTitle: "No KSeF token",
          tokenMissingBody: "This is fine while testing. Real submission requires a token.",
          ...
          accountantEmail: "Accounting email",
          accountantEmailHelp: "Optional. This address is prefilled when sending XML/PDF packets from the Invoices tab.",
          test: "Test connection",
          save: "Save settings",
          saveAndTest: "Save and test token",
        ...
        orders: {
          ...
          buyerJst: "Buyer is local government",
          buyerGv: "Buyer is VAT group",
          saveFlag: "Save B2B flag",
          generate: "Generate invoice",
          generateReady: "Generate ready drafts",
          nipSource: "NIP source: {{source}}",
          devCurrency: "Dev mode: this {{currency}} test order will use an NBP rate and VAT-in-PLN FA(3) fields.",
        ...
        invoices: {
          ...
          validatedAt: "FA(3) validated: {{date}}",
          ...
          emailPlaceholder: "accounting@example.com",
          emailSent: "Invoice packet for {{orderName}} was sent to {{email}}.",
          emailError: "Could not send the invoice email.",
          ...
          submitted: "Submitted",
          submitStarted: "{{orderName}} was sent to the KSeF workflow.",
          submitError: "Could not submit invoice to KSeF.",
          refreshStatus: "Refresh KSeF status",
          statusRefreshed: "KSeF status refreshed for {{orderName}}.",
        ...
        queue: {
          ...
          workerRuntime: "Worker: every {{interval}}s, limit {{limit}}, last finished: {{last}}.",
          workerNever: "never",
